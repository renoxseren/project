  ...
  function s(i2) {
    return function(s2) {
      return function(i3) {
        ...
        for (; a; )
          try {
            if (t = 1, r && (o = 2 & i3[0] ? r.return : i3[0] ? r.throw || ((o = r.return) && o.call(r), 0) : r.next) && !(o = o.call(r, i3[1])).done)
              return o;
...
var Trie = function() {
  ...
  return e.prototype.insert = function(e2, n, t) {
    for (var r = this.root, o = stringToChars(e2), i = 0; i < o.length; i++)
      r.children[o[i]] || (r.children[o[i]] = new TrieNode(), r.children[o[i]].parent = r, r.children[o[i]].word[0] = r.word[0].concat(o[i])), r = r.children[o[i]], i === o.length - 1 && (r.end = true, r.word[1] = n, r.word[2] = t);
  }, e.prototype.commonPrefixSearch = function(e2) {
    for (var n = [], t = this.root.children[e2[0]], r = 0; r < e2.length && t; r++)
      t.end && n.push(t.word), t = t.children[e2[r + 1]];
...
var Tokenizer = function() {
  function e(e2, n) {
    ...
    for (var t = this.reservedSymbolsCount; t < this.vocabulary.length; t++)
      this.trie.insert(this.vocabulary[t][0], this.vocabulary[t][1], t);
  }
  return e.prototype.encode = function(e2) {
    var n = [], t = [], r = [];
    e2 = processInput(e2);
    for (var o = stringToChars(e2), i = 0; i <= o.length; i++)
      n.push({}), t.push(0), r.push(0);
    ...
    for (var v = [], p = t.length - 1; p > 0; )
      v.push(t[p]), p -= this.vocabulary[t[p]][0].length;
    var E = [], T = false;
...
var UniversalSentenceEncoderQnA = function() {
  ...
  return e.prototype.loadModel = function() {
    ...
    var n = this, t = tidy(function() {
      ...
      if (null != e2.contexts && e2.contexts.length !== e2.responses.length)
    ...
    for (var t = 0; t < n; t++)
      t >= e2.length ? e2[t] = TOKEN_PADDING : SKIP_VALUES.includes(e2[t]) || (e2[t] += OFFSET);
    return e2.slice(0, n);
  }, e;
}();
